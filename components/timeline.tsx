  ...
  return (
    <div
      className={`space-y-12 relative ${
        !isMobile
          ? "before:absolute before:inset-0 before:left-1/2 before:ml-0 before:-translate-x-px before:border-l-2 before:border-forest before:h-full before:z-0"
          : ""
      }`}
    >
      {experiences.map((experience, index) => (
        ...
        >
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="relative overflow-hidden rounded-xl bg-darkgreen/50 backdrop-blur-sm border border-darkgreen/50 p-6 transition-all duration-300 hover:border-sage/50">
              ...
              <div className="relative">
                ...
                <p className="text-beige/80">{experience.description}</p>
              </div>
            </div>
          </motion.div>
          ...
          {!isMobile && (
            <div className="absolute left-1/2 -translate-x-1/2 flex items-center justify-center">
              <motion.div
                className="w-6 h-6 rounded-full bg-gradient-to-r from-sage to-beige z-10 flex items-center justify-center"
                initial={{ scale: 0 }}
                whileInView={{ scale: 1 }}
