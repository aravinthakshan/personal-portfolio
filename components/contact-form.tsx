          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <Input
                ...
                required
                className="bg-darkgreen/50 border-forest focus:border-sage focus:ring-sage/20"
              />
            </div>
            <div className="space-y-2">
              <Input
            ...
            <Button
              type="submit"
              className="w-full bg-gradient-to-r from-sage to-beige hover:from-beige hover:to-sage border-0 text-darkgreen"
