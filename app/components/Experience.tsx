    ...
    <section id={id} className="py-20 px-6 bg-[#0A0B14]">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="relative">
          {/* Center timeline */}
          <div className="absolute left-1/2 top-0 bottom-0 w-0.5 bg-[#6366F1]/20" />
          ...
          <div className="relative space-y-12">
            {experiences.map((exp, index) => (
              ...
              >
                {/* Timeline dot */}
                <div className="absolute left-1/2 w-4 h-4 rounded-full bg-[#6366F1] transform -translate-x-1/2" />
                ...
                <div
                  className={`absolute top-1/2 transform -translate-y-1/2 ${
                    exp.side === "left"
                      ? "left-[calc(50%_-_1px)]"
                      : "right-[calc(50%_-_1px)]"
                  } h-0.5 bg-[#6366F1]/20 w-8`}
                />

                <div
                  className={`card-gradient rounded-lg border border-[#6366F1]/20 shadow-lg w-[calc(50%-2rem)] 
                  ${exp.side === "left" ? "mr-auto" : "ml-auto"}`}
                >
                  <div className="p-6">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 rounded-full bg-[#1A1B23] flex-shrink-0 flex items-center justify-center text-[#6366F1]">
                        {exp.icon}
                      </div>
                      <div className="flex-1">
                        <div className="flex flex-wrap justify-between items-start mb-2">
                          ...
                          <span className="text-gray-400 text-sm bg-[#1A1B23] px-3 py-1 rounded-full mt-1">
                            {exp.date}
                          </span>
                        </div>
