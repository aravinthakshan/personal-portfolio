...
export default function Hero() {
  return (
    <section className="min-h-screen flex items-center justify-center px-6 pt-20 relative overflow-hidden">
      {/* Background gradient */}
      <motion.div
        className="absolute top-0 right-0 w-1/3 h-1/3 bg-gray-800/20 blur-[120px] rounded-full"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.5, 0.8, 0.5],
        }}
      ...
      />
      <motion.div
        className="absolute bottom-0 left-0 w-1/3 h-1/3 bg-gray-800/20 blur-[120px] rounded-full"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.5, 0.8, 0.5],
        }}
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          <div className="space-y-2">
            ...
            <motion.h1
              className="text-5xl md:text-6xl font-bold text-gray-300"
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.3 }}
            >
          ...
          >
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-6 py-3 bg-gray-800 text-gray-300 rounded-lg flex items-center gap-2"
            >
              About Me
            </motion.a>
            <motion.a
          ...
          >
            {[
              {
                icon: <Brain className="w-8 h-8 text-gray-400 mb-2" />,
                title: "ML/AI",
                subtitle: "Deep Learning Expert",
              },
              {
              ...
              {
                icon: <Code className="w-8 h-8 text-gray-400 mb-2" />,
                title: "Full Stack",
                subtitle: "MERN Developer",
              },
            ].map((item, index) => (
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="w-full h-full absolute -z-10 bg-gray-800/20 blur-[120px] rounded-full" />
          <motion.div
            className="relative w-full aspect-square max-w-md mx-auto"
            whileHover={{ scale: 1.05 }}
            transition={{ type: "spring", stiffness: 300 }}
