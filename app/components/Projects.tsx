...
export default function Projects() {
  return (
    <section id="projects" className="py-20 px-6 bg-gray-900/30 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 mt-2">Showcasing my best work in AI and software development.</p>
        </motion.div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            ...
            >
              <div className="relative h-64">
                ...
                <div className="absolute bottom-4 left-4 flex gap-2">
                  {project.tags.map((tag) => (
                    <span key={tag} className="bg-indigo-600/90 px-3 py-1 rounded-full text-sm text-white">
                      {tag}
                    </span>
                  ))}
                </div>
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-4 text-indigo-400">{project.title}</h3>
